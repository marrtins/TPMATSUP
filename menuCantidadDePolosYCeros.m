...
c1 = uicontrol(h, "style", "edit", "position", [150 250 250 30], "callback", "deshabilitarCampoEdit(gcbo),cantidadPolos = obtenerNumeroDeUnCampoTexto(gcbo)");
b2 = uicontrol(h, "style", "text", "string", "Ingrese la cantidad de ceros:", "position", [150 200 250 30]);
c2 = uicontrol(h, "style", "edit", "position", [150 150 250 30], "callback", "deshabilitarCampoEdit(gcbo),cantidadCeros = obtenerNumeroDeUnCampoTexto(gcbo)");
