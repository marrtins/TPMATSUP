...
c1 = uicontrol(h, "style", "edit", "position", [150 250 250 30], "callback", "gradoNumerador = obtenerNumeroDeUnCampoTexto(gcbo)");
b2 = uicontrol(h, "style", "text", "string", "Ingrese el grado del denominador", "position", [150 200 250 30]);
c2 = uicontrol(h, "style", "edit", "position", [150 150 250 30], "callback", "gradoDenominador = obtenerNumeroDeUnCampoTexto(gcbo)");
